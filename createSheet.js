...
function printSystmeSheet(){
	...
	var allTrTableEventsHtmlStr1='<table class="bigTable bodernone"><tr><td class="imgheader"> <img src="'+imgurl+'"> </td></tr></table> <div class="tableseparator"> </div><table class="bigTable">		<tr >			<td>				<table class="playTable tableHeader">					<tr class="dashedlineSystem">						<td>CODE</td>						<td class="rigthElem">PR10QRPTQARWR-'+sheetCodeNumber+'</td>					</tr>														<tr>					    <td></td>						<td class="rigthElem">'+sheetCodeNumber+'-Rayen Khlifa</td>					</tr>				</table>				<hr class="dashedline"></hr>			</td>		</tr>		</table>	<div class="tableseparator"> </div>	<table class="bigTable">		<tr class="solidBorder">			<th class="_96pt">SYST&#200;ME</th>		</tr>';
